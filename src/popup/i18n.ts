const fallbackMessages = {
  ...
  onboardingGuideCopy: "最初の記録は、のんだ直後に「$1」を1回押すだけです。保存されるのは時刻だけです。",
  onboardingGuideAction: "次にやること：大きな「$1」ボタンを押します。",
  onboardingGuideResult: "押したあと、直近の記録と最近の記録に時刻が表示されます。",
  lastRecordTitle: "直近の記録",
  emptyLatestRecord: "まだ記録はありません。最初に保存した時刻がここに表示されます。",
  historyTitle: "最近の記録",
  emptyHistoryRecords: "履歴はまだありません。最初の記録を保存すると、最近の時刻が最大$1件までここに並びます。",
